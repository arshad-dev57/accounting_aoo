...
class ChartOfAccountsScreen extends StatelessWidget {
      ...
      body: Obx(() {
        ...
        return Column(
          children: [
            ...
            Expanded(
              child: _buildAccountsList(controller),
            ),
          ],
        );
      }),
  ...
  Widget _buildSummaryCards(ChartOfAccountController controller) {
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Obx(() => Row(
          children: [
            _buildSummaryCard('Assets', controller.totalAssets.value, const Color(0xFF2ECC71), Icons.account_balance),
            const SizedBox(width: 12),
            _buildSummaryCard('Liabilities', controller.totalLiabilities.value, const Color(0xFFE74C3C), Icons.payment),
            const SizedBox(width: 12),
            _buildSummaryCard('Equity', controller.totalEquity.value, const Color(0xFF3498DB), Icons.account_balance_wallet),
            const SizedBox(width: 12),
            _buildSummaryCard('Income', controller.totalIncome.value, const Color(0xFF2ECC71), Icons.trending_up),
            const SizedBox(width: 12),
            _buildSummaryCard('Expenses', controller.totalExpenses.value, const Color(0xFFE74C3C), Icons.trending_down),
          ],
        )),
      ),
    );
  ...
  Widget _buildAccountTypeFilter(ChartOfAccountController controller) {
  ...
  Widget _buildAccountsList(ChartOfAccountController controller) {
    return Obx(() {
              ...
              children: [
                ...
                if (account['description'] != null && account['description'] != '')
                  Padding(
                    ...
                    child: Row(
                      children: [
                         Icon(Icons.info_outline, size: 14, color: kSubText),
                        const SizedBox(width: 4),
                        Expanded(
                          child: Text(
                            account['description'],
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow('Current Balance', _formatAmount(account['balance'])),
            _buildDetailRow('Balance Type', account['balanceType']),
            _buildDetailRow('Parent Account', account['parentAccount'] ?? 'N/A'),
            _buildDetailRow('Tax Code', account['taxCode'] ?? 'N/A'),
            _buildDetailRow('Description', account['description'] ?? 'No description'),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
           Text('Show accounts with:'),
            const SizedBox(height: 12),
            Obx(() => CheckboxListTile(
              value: true,
              title:Text('Positive Balance'),
              controlAffinity: ListTileControlAffinity.leading,
              onChanged: (value) {},
            )),
            Obx(() => CheckboxListTile(
              value: false,
              title:Text('Zero Balance'),
              controlAffinity: ListTileControlAffinity.leading,
              onChanged: (value) {},
            )),
            Obx(() => CheckboxListTile(
